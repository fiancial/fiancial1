...
(function($, version)
{
                ...
                var attachIFrame = function()
                  {
                    ...
                    container.prev().css({ width: table.width(), height: container.height(), opacity: 0, position: 'fixed', left: container.css("left"), top: '20px' });
                  };
                if (settings.window.expandable)
                {
  ...
  $.fn.jPicker.defaults = /* jPicker defaults - you can change anything in this section (such as the clientPath to your images) without fear of breaking the program */
      ...
      images:
        {
          clientPath: '/cpserver/images/', /* Path to image files */
          colorMap:
          {
            width: 256,
            height: 256,
