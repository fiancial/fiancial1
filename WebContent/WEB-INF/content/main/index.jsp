		...
		<div id="header">
			<div class="headerNav">	
				<ul class="nav">
					...
					<li id="switchEnvBox"><a href="#">帐户:${sessionScope.USER_SESSION.userName}</a></li>										
					...
					<div class="accordionContent">
						...
						<!-- <right:rightTag rightCode="100"> -->
							...
							<!-- 	 </right:rightTag>
								...
								<!--  </right:rightTag> -->
									<li><a href="${ctx}/test/upload.do" target="navTab" external="false" rel="upload">上传下载</a></li>
								</ul>
							</li>
						<!-- </right:rightTag>
							 -->
