		...
		<div id="header">
			<div class="headerNav">
				<ul class="nav">
					...
					<li><a class="common-img" width="400" height="200"
						href="${ctx}/core/userManager/initChangePwd.do" target="dialog"
						mask="true" title="修改密码">修改密码</a></li>
					<li><a href="${ctx}/login/loginout.do">退出</a></li>
				</ul>
						...
						<ul class="tree treeFolder">
								...
								<li><a>权限管理</a>
									<ul>
										...
										<li><a href="${ctx}/user/userList.do?pageNum=1"
											target="navTab" external="false" rel="userList">用户列表</a></li>
							...
							<li><a>权限管理</a>
								<ul> 
									...
									<li><a href="${ctx}/innerUser/innUserList.do" target="navTab" external="false" rel="userList">用户列表</a></li>
								 
								    <li><a href="${ctx}/role/roleList.do" target="navTab" external="false" rel="roleList">角色列表</a></li>
								 
									<li><a href="${ctx}/right/rightTree.do" target="navTab" external="false" rel="rightTree">权限列表</a></li>
			...
			<div id="navTab" class="tabsPage">
				...
				<div class="navTab-panel tabsPageContent layoutBox">
					<div class="page unitBox">
						<div style="width: 100%; position: absolute; top: 0px; left: 0"
							layoutH="5">
